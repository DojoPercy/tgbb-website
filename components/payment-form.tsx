...
export default function PaymentForm({ 
  ...
  const membershipTypes = [
    { value: 'annual', label: 'Annual Membership', price: 500 },
    { value: 'lifetime', label: 'Lifetime Membership', price: 2000 },
    { value: 'corporate', label: 'Corporate Membership', price: 1500 }
  ]

  const selectedMembership = membershipTypes.find(type => type.value === formData.membershipType)
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span>{selectedMembership?.label}</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            >
              {isProcessing ? (
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Complete Payment - ${selectedMembership?.price}</span>
                </div>
              )}
            </Button>
          </form>
